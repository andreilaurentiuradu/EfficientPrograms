...
void readFileIntoMap(const string& filePath, robin_hood::unordered_map<string, vector<string>>& data) {
...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        robin_hood::unordered_map<string, vector<string>> file1Data, file2Data, file3Data, file4Data;
