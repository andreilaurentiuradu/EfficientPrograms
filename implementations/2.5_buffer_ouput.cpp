...
int main(int argc, char* argv[]) {
    ...
    file1Data.reserve(10000000);
    file2Data.reserve(10000000);
    file3Data.reserve(10000000);
    file4Data.reserve(10000000);
    ...
    // Flush the entire output buffer to std::cout in one go
